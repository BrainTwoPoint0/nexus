...
const contactMethods = [
    {
        icon: Mail,
        title: 'Email Support',
        description: 'Get help with your account, technical issues, or general inquiries',
                ...
                >
                    ...
                    <motion.section variants={itemVariants} className="text-center space-y-6">
                        ...
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                            We&apos;re here to help you succeed. Whether you have a question about our platform,
                    ...
                    >
                        {contactMethods.map((method, index) => (
                            <motion.div key={index} variants={itemVariants} className="h-full">
                                <Card className="h-full p-6 hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-primary/10 group">
                                    <CardContent className="p-0 h-full flex flex-col justify-between text-center">
                                    ...
                                    <CardContent className="p-0 space-y-4">
                                        ...
                                        <div className="border-t border-border pt-4">
                                            <p className="text-xs text-muted-foreground">
                                                Live chat and emergency support available 24/7 for Enterprise clients.
                                            </p>
                                        </div>
                                    </CardContent>
                                </Card>
