...
const mockRecentActivity = [
  {
    type: 'application',
    message: 'You applied for Non-Executive Director at GreenTech Solutions',
    time: '2 hours ago',
  },
  {
    type: 'view',
    message: 'Your profile was viewed by Healthcare Innovations Ltd',
    time: '5 hours ago',
  },
  {
    type: 'match',
    message: 'New opportunity matched: Audit Committee Member',
    time: '1 day ago',
  },
  {
    type: 'event',
    message: 'Reminder: Board Governance Webinar tomorrow at 2 PM',
    time: '1 day ago',
  },
];
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">{titleAndCompany}</p>
              </div>
            </div>
