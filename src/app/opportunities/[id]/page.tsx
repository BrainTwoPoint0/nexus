...
const opportunity = {
  ...
  company: {
    ...
    location: 'London, UK',
    description:
      'A leading venture capital firm focused on early-stage technology companies across Europe.',
  },
  location: 'London, UK',
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    {opportunity.requirements.essential.map(
                      (requirement, index) => (
                        <li key={index} className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {opportunity.requirements.desirable.map(
                      (requirement, index) => (
                        <li key={index} className="flex items-start gap-3">
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    ...
                    <p className="mb-4 text-sm text-muted-foreground">
                      Join {opportunity.company.name} as their next{' '}
                      {opportunity.title}
                    </p>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {opportunity.applicationProcess.timeline}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm">
                    <p className="text-muted-foreground">
                      ...
                      {opportunity.applicationProcess.contact}
                    </p>
                  </div>
                </div>
              </CardContent>
